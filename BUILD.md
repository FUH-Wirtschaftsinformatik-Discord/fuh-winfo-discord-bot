...
docker build -f .\plotter.Dockerfile -t rndintusr/fuh-winfo-discordbot-grade-plotter:v1.0.1 .
docker push rndintusr/fuh-winfo-discordbot-grade-plotter:v1.0.1
```
